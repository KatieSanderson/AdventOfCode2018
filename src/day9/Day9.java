...
public class Day9 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		Day9 day = new Day9(new File("src\\day9\\inputDay9Long.txt"));
		//		Day9 day = new Day9(new File("src\\day9\\inputDay9Short.txt"));
		//		Day9 day = new Day9(new File("C:\\Users\\Katie\\Documents\\Advent of Code\\9\\input.txt"));
		day.solve();
	}
