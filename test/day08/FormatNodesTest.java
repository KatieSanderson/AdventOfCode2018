...
public class FormatNodesTest {
	...
	public void oneNode() {
		...
		Assert.assertEquals(15, formatNodes.getHeadNode().getNodeSum());
	}
	...
	public void twoNodesOneChild() {
		...
		Assert.assertEquals(0, formatNodes.getHeadNode().getNodeSum());
	}
	...
	public void twoNodesNoChildren() {
		...
		Assert.assertEquals(39, formatNodes.getHeadNode().getNodeSum());
	}
	...
	public void givenTest() {
		...
		Assert.assertEquals(66, formatNodes.getHeadNode().getNodeSum());
	}
}
